...
console.log(concatenated); // Output: "React JS , Native"

// 4 constructor
const str5 = "My name is Ali";
const constructor = str5.constructor;
console.log(constructor); // Output: [Function: String]

// 5 endsWith()
const str6 = "Hello, Everyone!";
const endsWithWorld = str6.endsWith("Everyone!");
...
// 16 search()
const str18 = "My Name is Ahmar Ali";
const searchResult = str18.search("Ahmar");
...
// 27 trim()
const str29 = "   Developers in Java   ";
const trimmed = str29.trim();
console.log(trimmed); // Output: "Developers in Java"
